...
std::vector<std::vector<int16_t>> SmallTriangle{ {3},
                                                 {7, 4},
                                                 {2, 4, 6},
                                                 {8, 5, 9, 3}, };

std::vector<std::vector<int16_t>> BigTriangle{ {75},
                                               {95, 64},
                                               {17, 47, 82},
                                               {18, 35, 87, 10},
                                               {20, 04, 82, 47, 65},
...
std::vector<std::vector<int16_t>> get_max_paths(const std::vector<std::vector<int16_t>> input) {
...
int main()
{
    ...
    auto max_paths = get_max_paths(BigTriangle);
