...
// Each candy centre is shaped like an ellipsoid of revolution defined by the equation:
...
//
// If a = 1 mm and b = 1 mm, the amount of chocolate required is 28/3 pi mm^3
